...
export default function Footer() {
  // Use auth context for role-based footer links
  const { user } = useAuth();
      ...
      <div className="footer-inner">
        ...
        <div className="footer-links">
          <div className="footer-col">
            <h4>Office</h4>
            <p className="footer-address">Road-07, House-35, Block-G, Banani</p>
            <p className="footer-address">Road-24, House-21, Block-K, Banani</p>
            {isCustomer && <><Link to="/customer/dashboard">Home</Link><Link to="/customer/products">All Products</Link></>}
            {isSeller   && <><Link to="/seller/dashboard">Dashboard</Link><Link to="/seller/products">My Products</Link></>}
          </div>
          <div className="footer-col">
            <h4>Follow Us</h4>
            <p className="footer-phone">+880 1323933930</p>
            <a href="#" className="footer-social-link">
              <svg className="footer-social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d={FB_PATH}/></svg>
              marketplace
            </a>
            <a href="#" className="footer-social-link">
              <svg className="footer-social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d={IG_PATH}/></svg>
              market_place
            </a>
          </div>
          <div className="footer-col">
            ...
            {isSeller   && <Link to="/seller/orders">Orders Received</Link>}
          </div>
        </div>
      </div>
